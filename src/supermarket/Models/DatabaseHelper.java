...
public class DatabaseHelper {
    ...
    public void Add_User(String Name, String Email, String PhoneNo, String Country, String Password){
        try {
            PreparedStatement statement = con.prepareStatement("INSERT INTO Users (Username, Email, PhoneNO, Country, Password) VALUES (?,?,?,?,?);");
